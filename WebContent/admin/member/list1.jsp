            ...
            <section id="notice">
               ...
               <table>
                  ...
                  <tbody>
                     <tr>
                        <td class="num">3</td>
                        <td class="title"><a href="">자바 백엔드 개발자들을 위한 새로운 강의를 녹음
                              중에 있습니다. <span>[23]</span>
                        </a></td>
                     ...
                     <tr>
                        <td class="num">2</td>
                        <td class="title"><a href="">유투브에 jQuery와 Angular 프레임워크
                              1강이 등록되었습니다.<span>[10]</span>
                        </a></td>
                        <td class="writer">newlec</td>
                        <td class="date">2019-02-18</td>
                        <td class="hit">177</td>
                     ...
                     <tr>
                        <td class="num">1</td>
                        <td class="title"><a href="">앞으로 모든 강의를 무료로 새로 시작합니다.<span>[5]</span></a></td>
                        <td class="writer">newlec</td>
   ...
   <footer id="footer">
      <div class="content-box">
         <!-- <section>
            ...
            <section>
                <h3>저작권 정보</h3>
                Copyright ⓒ newlecture.com 2012-2014 All Right Reserved. Co
                ntact admin@newlecture.com for more information
            </section>
        </section> -->
      </div>
   </footer>
