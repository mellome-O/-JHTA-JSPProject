...
@WebServlet("/notice/listpartial")
public class ListPartailController extends HttpServlet{
...
//      response.addCookie(cookie);
      ...
      NoticeDao noticeDao  = new OracleNoticeDao();
       ...
       request.getRequestDispatcher("/WEB-INF/view/notice/listpartial.jsp").forward(request, response);
   }
